	...
	public function all() {
		return array(
			...
			array(
				...
				'params'          => array( 'code', 'checkin', 'checkout', 'adults', 'children', 'rooms', 'voucher', 'offline' ),
			...
			array(
				...
				'params'          => array( 'code', 'checkin', 'checkout', 'rate' ),
				'category'        => 'availability',
				'resource'        => 'WH_Availability_API',
			...
			array(
				...
				'params'          => array( 'code', 'fromd', 'tod', 'adults', 'children', 'room', 'rate' ),
				'category'        => 'availability',
				'resource'        => 'WH_Availability_API',
				'resource_method' => 'calendar',
			),
			array(
				'key'             => 'availability.flexible_calendar',
				'label'           => __( 'Flexible calendar', 'webhotelier' ),
				'method'          => 'GET',
				'path_template'   => '/availability/{code}/flexible-calendar',
				'params'          => array( 'code', 'month', 'nights' ),
				'category'        => 'availability',
				'resource'        => 'WH_Availability_API',
				'resource_method' => 'flexible_calendar',
			),
			array(
				...
				'params'          => array( 'code', 'checkin', 'checkout' ),
				'category'        => 'availability',
				'resource'        => 'WH_Availability_API',
				'resource_method' => 'bar',
			),
			array(
				...
				'params'          => array( 'code', 'rateId', 'checkin', 'checkout' ),
				'category'        => 'availability',
				'resource'        => 'WH_Availability_API',
				'resource_method' => 'extras',
			),
			...
			array(
				...
				'params'          => array( 'code', 'rate', 'checkin', 'checkout', 'adults', 'payment_method' ),
				'category'        => 'bookings',
			...
			array(
				'key'             => 'bookings.confirmation_email',
				...
				'category'        => 'bookings',
				'resource'        => 'WH_Bookings_API',
				'resource_method' => 'confirmation_email',
			),
			array(
				'key'             => 'bookings.search',
			...
			array(
				...
				'category'        => 'bookings',
				'resource'        => 'WH_Bookings_API',
				'resource_method' => 'mark_synced',
			),
			array(
				'key'             => 'bookings.push_ping',
			...
			array(
				'key'             => 'vouchers.manage_code',
				'label'           => __( 'Manage voucher code', 'webhotelier' ),
				'method'          => 'POST',
				'path_template'   => '/voucher/{bundleId}/{code}',
				'params'          => array( 'bundleId', 'code', 'action', 'value' ),
				'category'        => 'vouchers',
				'resource'        => 'WH_Vouchers_API',
				'resource_method' => 'manage_code',
			),
			...
			array(
				...
				'params'          => array( 'code', 'date_from', 'date_to' ),
				'category'        => 'statistics',
				'resource'        => 'WH_Stats_API',
				'resource_method' => 'summary',
			),
			array(
				'key'             => 'statistics.per_day',
				...
				'category'        => 'statistics',
				'resource'        => 'WH_Stats_API',
				'resource_method' => 'per_day',
			),
			array(
				'key'             => 'statistics.per_country',
